...
//        efs.create(fileName, userName, password);
        ...
        efs.write(fileName, 776, text.getBytes(), password);

        String readFile = "/Users/vigneshthirunavukkarasu/Info-sec/sample.txt";
        int readPos = 777;
        int readLength = 5;
...
//        efs.write(fileName, 5, "this is a test".getBytes(), password);
