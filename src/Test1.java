...
//        byte[] iv = "1234567890123456".getBytes();
        ...
        byte[] messageByte = file2.getBytes();
    ...
    public static byte[] blockEncrypt(byte[] message, byte[] iv, int blockSize, int fileSize ) throws Exception {

        byte[] padded = zeroPad(message, fileSize);
    ...
    public static void incrementIV(byte[] iv, int incrementBy) {
